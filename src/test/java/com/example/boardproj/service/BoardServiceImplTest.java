...
class BoardServiceImplTest {
    ...
    public void pagelistTest2(){
        ...
        // 필요한 값은 size  , page  , type  , keyword
        //         없어도 10, 없어도 1
        // type이 t일때 제목을 검색하고, 내부에서는 like를 쓴다.
        ...
        // 시작 패이지, 끝 페이지, 이전여부, 다음여부
        log.info("시작 페이지 : " + pageResponseDTO.getStart());
        log.info("끝 페이지 : " + pageResponseDTO.getEnd());
        log.info("이전 여부 : " + pageResponseDTO.isPrev());
        log.info("다음 여부 : " + pageResponseDTO.isNext());
